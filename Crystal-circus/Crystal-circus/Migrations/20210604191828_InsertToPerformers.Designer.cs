...
namespace Crystal_circus.Migrations
{
    ...
    [Migration("20210604191828_InsertToPerformers")]
    partial class InsertToPerformers
    {
            ...
            modelBuilder.Entity("Crystal_circus.Models.PerformerModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Image = "https://i.cbc.ca/1.5247534.1565824743!/fileImage/httpImage/image.jpg_gen/derivatives/original_780/cirque-du-soleil-luzia.jpg",
                            Name = "Raneen",
                            PhoneNumber = 56738289,
                            Profession = "Magician"
                        });
                });
