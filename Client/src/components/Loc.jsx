...
const Loc = () => {
    ...
    const updateCoordinates = (e) => {
        ...
        .then(response => {
           /// setLatitude(response.data.results[0].formatted_address.geometry.location.lat)
            console.log(response)
           // setLongitude(response.data.results[0].formatted_address.geometry.location.lng)
        })
